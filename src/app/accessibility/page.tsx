            ...
            "@graph": [
              {
                ...
                description:
                  "Accessibility statement outlining the digital accessibility features, standards and ongoing improvements for British & Irish travel writer and photographer James Merriman.",
                isPartOf: {
