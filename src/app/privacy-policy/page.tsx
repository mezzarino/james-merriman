...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Privacy Policy | James Merriman",
    description: "Read the privacy policy for James Merriman's website. Learn how your personal data is collected, used and protected in compliance with UK data protection laws.",
    images: [
      {
        url: ogImage,
        width: 1200,
      ...
      <main className="container mx-auto mt-8 px-4 max-w-6xl" role="main">
        <div className="flex flex-col lg:flex-row">
          <div className="w-full prose prose-lg max-w-none break-words blog-content">
            ...
            <ul>
              <li><strong>Contact Information:</strong> If you use the contact form on our website we will collect your name, email address and the contents of your message. This information is not stored on the website database but is sent directly to us as a standard email.</li>
              <li><strong>Usage Data:</strong> When you visit the site we automatically collect information about your equipment, browsing actions and patterns. This includes your IP address, browser type, operating system and the pages you view.</li>
            </ul>
            ...
            <p>Under UK data protection law you have specific rights regarding your personal information. These include the right to:</p>
            <ul>
            ...
            <p>
              To exercise any of these rights please <Link href="/contact">get in touch via the contact form</Link> on this website.
            </p>
