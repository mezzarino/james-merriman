...
<amp-story
  ...
  poster-portrait-src="https://stories.jamesmerriman.co.uk/stories/afghanistan-anxious-explorer/images/id-layer template="fill">
...
<amp-story-page id="cta">
  ...
  <amp-story-grid-layer template="vertical">
    ...
    <p>
      <a href="https://www.jamesmerriman.co.uk">
        Explore more →
      </a>
    </p>
  </amp-story-grid-layer>
