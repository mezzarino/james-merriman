          ...
          __html: JSON.stringify({
            ...
            "@graph": [
              // ✅ Collection page
              {
                ...
                description:
                  "A selection of travel writing, reportage and fieldwork by British & Irish travel writer James Merriman, published in international magazines, guidebooks and national newspapers.",
                isPartOf: {
                  "@id": websiteId,
                },
                about: {
