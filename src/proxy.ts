...
export function proxy(request: NextRequest) {
  ...
  const cspHeader = `
  default-src 'self';
  connect-src 'self' https://www.wisp.blog https://*.google-analytics.com https://*.google.com https://*.cloudinary.com https://*.doubleclick.net https://*.ampproject.org https://*.githubusercontent.com;
  script-src 'self' 'nonce-${nonce}' https://www.googletagmanager.com https://cdn.ampproject.org;
