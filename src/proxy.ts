...
export function proxy(request: NextRequest) {
  ...
  const cspHeader = `
  default-src 'self';
  connect-src 'self' https://www.wisp.blog https://www.google-analytics.com https://region1.google-analytics.com https://region1.analytics.google.com https://*.cloudinary.com;
